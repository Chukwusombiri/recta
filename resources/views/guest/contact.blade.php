            ...
            <a href="{{ config('app.socials.whatsapp_link') }}"
                ...
                <div class="w-full flex flex-wrap justify-between items-center">
                    <div class="flex flex-col justify-center">
                        <h2 class="text-3xl md:text-5xl futura-medium mb-2 md:mb-6">Send a WhatsApp message</h2>
                        <p class="text-sm md:text-xl">Our team are always eager to talk to you</p>
                    </div>
